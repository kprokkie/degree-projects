<%@ Page Title="" Language="C#" MasterPageFile="~/musicvalley.master" AutoEventWireup="true" CodeFile="classify.aspx.cs" Inherits="Default3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="border: thin #000000 dotted; width: 100%; height: 694px;">
    <tr>
        <td>
            <div style="height: 688px">
                <table style="width: 100%; height: 689px;">
                    <tr>
                        <td style="border: thin #000000 dotted; height: 51px">
                            <div style="font-family: Calibri; font-size: large; color: #0000FF; text-transform: uppercase; text-align: center;">
                                <strong><span style="color: #FF0000">&lt;&lt;</span> PRODUCTS<span 
                                    style="color: #FF0000"> &gt;&gt;</span></strong></div>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
&nbsp;<img alt="" src="WebImages/arr.jpg" /><span style="font-family: Calibri; font-size: large"><strong>CONTEMPORY</strong></span></div>
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton2" runat="server" Height="119px" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton3" runat="server" Height="119px" 
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton4" runat="server" Height="119px" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton6" runat="server" Height="119px" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton7" runat="server" Height="119px" 
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton8" runat="server" Height="119px" 
                                    ...
                                    <tr>
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton9" runat="server" Height="119px" 
                                        ...
                                        <td>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:ImageButton ID="ImageButton10" runat="server" Height="119px" 
