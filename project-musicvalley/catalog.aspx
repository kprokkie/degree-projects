<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="catalog.aspx.cs" Inherits="Default3" %>
            ...
            <td>
                <div style="height: 687px">
                    <table style="width: 100%; height: 687px;">
                        <tr>
                            <td class="style43" 
                                style="border: thin #000000 dotted; height: 53px; text-align: center;">
                                <div>
                                    &nbsp;<span style="font-family: Calibri"><strong><span 
                                        style="color: #FF0000; font-size: large">&lt;&lt; </span>
                                    <span style="color: #0000FF; font-size: large">MODIFY PRODUCT WIZARD </span>
                                    <span style="color: #FF0000; font-size: large">&gt;&gt; </span></strong></span></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
